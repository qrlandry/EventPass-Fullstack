...
export default function Home(){
  return(
    <div className="home">
      <Nav />
      <SearchBar />
      <h2 className="home-display">Featured Events of the Week</h2>
      <div className="third">
      ...
      <h2 className="home-display" style={{marginTop: '0'}}>Tonight!</h2>  
      ...
      <h2 className="home-display">Need a good laugh?</h2> 
      <div className="third" id='bottom'>
        <div className="bottom-items">
          ...
          <div className="bottom-item">
            <img src="https://m.media-amazon.com/images/M/MV5BNzlmMmFkZTMtZDg3Zi00ZjJmLWJiNzEtZTk0ZWJiZjVkMmRjXkEyXkFqcGdeQXVyMTMzNzIyNDc1._V1_.jpg" alt="ricky gervais" className="bottom-image" />
          </div>
          <div className="bottom-item">
            <img src="https://www.propeller.la/cdn-cgi/image/fit=scale-down,width=1000,format=auto,quality=40/files/taylor_tomlinson-propeller-poster-v2_19660.jpg" alt="ricky gervais" className="bottom-image" />
          </div>
          <div className="bottom-item">
            <img src="http://www.maconcentreplex.org/wp-content/uploads/2022/11/RC2023_Macon_Website-Featured_426x640.jpg" alt="ricky gervais" className="bottom-image" />
          </div>
          <div className="bottom-item">
          <img src="https://images.discovery-prod.axs.com/2023/02/uploadedimage_63fccfdf632fd.jpg" alt="kevin hart" className="bottom-featured" />
        </div>
        </div>

      </div>
      <h2 className="home-display" style={{textAlign: 'center', marginBottom: '1vh'}}>Only a few seats left!</h2> 
      <img src="https://i.ytimg.com/vi/cJAObWRmWvM/maxresdefault.jpg" alt="" />
