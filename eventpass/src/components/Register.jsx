...
export default function Register(){
  ...
  const [ inputValues, setInputValues ] = useState({email: '', password: '', firstName:'', lastName:'', residenceState: ''})
  ...
  return (
    <div className="register-form">
      ...
      <form onSubmit={handleSubmit}>
        <input type="text" name='firstName' placeholder='first name' id='login-firstName' onChange={handleChange}/>
